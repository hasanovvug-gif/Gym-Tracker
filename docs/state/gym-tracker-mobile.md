...
карточка на трёх языках написана, скриншоты 6.9″ сняты. **Обе сборки прошли обработку и лежат в TestFlight** — build #1 и build #2
(с фиксом `en.common.done`, ставить надо его). Всё в `main`, дерево чистое, синхронно с origin.
